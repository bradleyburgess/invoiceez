...
**data** | [**CurrencyListDto**](CurrencyListDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CurrencyListDtoApiResponse } from './api';

const instance: CurrencyListDtoApiResponse = {
    code,
    message,
    formErrors,
    data,
