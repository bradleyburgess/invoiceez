...
**data** | [**Array&lt;CustomerDto&gt;**](CustomerDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CustomerDtoIEnumerableApiResponse } from './api';

const instance: CustomerDtoIEnumerableApiResponse = {
    code,
    message,
    formErrors,
    data,
